...
The Go reference implementation of [asciicharts principles v1.3](../docs/spec/principles.md): numbers in, a text
...
[conformance suite](../test/conformance/) — 317 corpus cases, 117 curated cases (text in any script,
