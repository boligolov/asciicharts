...
`../CHANGELOG.md`, and regenerate the documentation examples (`scripts/gallery_refresh.py`,
`scripts/site_examples.py`, `scripts/sync_skill.py`).

## Licence

Like the rest of `spec/`, this suite is licensed under CC BY 4.0 (see `../LICENSE`).
