...
func newServer() *mcp.Server {
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Render numeric data as an ASCII/Unicode text chart. Supports sparkline, vbar, hbar, line, scatter, " +
			...
			"double/rounded), sub-character resolution for line/scatter/dual_axis (cell/quad/braille), and optional ANSI " +
			"256-color output. Returns the chart as plain text.",
	}, renderChart)
