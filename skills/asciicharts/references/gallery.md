...
the other way from a zero baseline); **`cell` / `quad` / `braille`** sub-character resolution for
line, scatter and dual-axis charts; **6 border styles**; **`halftone`**, **`ascii`** and **`dotted`**
