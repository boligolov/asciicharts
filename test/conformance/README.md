...
| `curated.json` | 108 named cases for what random specs barely reach — text in any script (CJK, emoji, combining marks, RTL), control characters, number formatting, each rule of v1.0, and **every validation message** (48 of the cases are errors): `[{"name": "...", "spec": ..., "out": "..."}]` or with `"err"` |
